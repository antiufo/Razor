...
namespace Microsoft.AspNet.Razor.Runtime.TagHelpers
{
    public class RuntimeTypeInfoTest
    {
        ...
        [InlineData(typeof(Dictionary<string, string>), typeof(IDictionary))]
        [InlineData(typeof(Dictionary<string, IDictionary<string, CustomType>>),
            typeof(IDictionary<string, IDictionary<string, CustomType>>))]
        public void ImplementsInterface_ReturnsTrueIfTypeImplementsInterface(Type type, Type interfaceType)
        {
            // Arrange
        ...
        [InlineData(typeof(string), typeof(IEnumerable<object>))]
        ...
        [InlineData(typeof(Dictionary<string, Dictionary<string, CustomType>>),
            typeof(IDictionary<string, IDictionary<string, CustomType>>))]
        public void ImplmentsInterface_ReturnsFalseIfTypeDoesNotImplementInterfaceOrTargetIsNotAnInterface(
            Type type,
            Type interfaceType)
        {
            // Arrange
